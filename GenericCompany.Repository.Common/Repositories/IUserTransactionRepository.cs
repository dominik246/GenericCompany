...
{
    public interface IUserTransactionRepository : IApplicationReadDbConnection<IUserTransactionPoco, IBaseFilterModel, IUrlFields>,
        IApplicationWriteDbConnection<IUserTransactionPoco, IBaseFilterModel>
    {
    }
}
